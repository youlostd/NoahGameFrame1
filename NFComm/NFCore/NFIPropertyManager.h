...
public:
    ...
    virtual NF_SHARE_PTR<NFIProperty> AddProperty(const NFGUID& self, const std::string& propertyName, const NFDATA_TYPE varType) = 0;

    virtual const NFGUID& Self() = 0;

	virtual std::string ToString() = 0;
    //////////////////////////////////////////////////////////////////////////
    virtual bool SetProperty(const std::string& propertyName, const NFData& TData) = 0;
